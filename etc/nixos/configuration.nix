...

{
  ...
  users.users.folclore = {
     ...
     createHome = true;
     home = "/home/folclore";
     extraGroups = [ "wheel" "networkmanager" "audio" "video" ]; # Enable ‘sudo’ for the user audio control and network.
  };
